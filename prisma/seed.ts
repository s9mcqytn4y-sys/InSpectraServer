...
async function upsertDefect(data: {
	...
	const existing = await prisma.masterDefect.findUnique({
...
async function main() {
	...
	const parts: {
		...
		// --- SEWING ---
		{
			...
			commodity: "SEWING",
			model: "D26A",
			customer: "BONECOM TRICOM",
		},
		{
			uniqNo: "B35",
			part_no: "71695-VT070-C",
			name: "PROTECTOR, RR SEAT BACK",
			commodity: "SEWING",
			model: "560B",
			customer: "BONECOM TRICOM",
		},
		...
		// --- Sewing (Seat Back Assy dari Gambar 1) ---
		{
			...
			part_no: "71702-VT020-C0",
			name: "BOARD SUB ASSY RR SEAT BACK LH",
			commodity: "SEWING",
			model: "560B",
			customer: "BONECOM TRICOM",
		},
		{
			...
			part_no: "71701-VT020-C0",
			name: "BOARD SUB ASSY RR SEAT BACK RH",
			commodity: "SEWING",
			model: "560B",
			customer: "BONECOM TRICOM",
		},
		...
		{
			uniqNo: "BT136",
			part_no: "11101-A1211-00",
			name: "FELT FRONT BACK RH",
			commodity: "PRESS",
			model: "560B",
			customer: "BONECOM TRICOM",
		},
		{
			uniqNo: "BT137",
			part_no: "11102-A1211-00",
			name: "FELT FRONT BACK RH (BT137)",
			commodity: "PRESS",
			model: "560B",
			customer: "BONECOM TRICOM",
		},
		{
			uniqNo: "BT144",
			part_no: "12101-A1211-00",
			name: "FELT FRONT BACK LH",
			commodity: "PRESS",
			model: "560B",
			customer: "BONECOM TRICOM",
		},
		...
		{
			uniqNo: "EQ5",
			part_no: "79117-0K060-A",
			name: "CARPET NO. 1 SEAT CUSHION",
			commodity: "PRESS",
			model: "650A",
			customer: "BONECOM TRICOM",
		},
	...
	const defects: {
		...
		// Sewing Defects
		{
			...
			name: "Sewing Putus",
			category: "PROSES",
			deskripsi: "Benang jahit putus di tengah jalur jahitan.",
		},
		{
			id_defect: "SEWING_LONCAT",
			name: "Sewing Loncat",
			category: "PROSES",
			deskripsi: "Jahitan meloncat/skip sehingga tidak membentuk kunci benang.",
		},
		{
			id_defect: "SEWING_LONGGAR",
			name: "Sewing Longgar",
			category: "PROSES",
			deskripsi: "Tegangan benang terlalu lemah sehingga jahitan kendur.",
		},
		{
			id_defect: "SEWING_MIRING",
			name: "Sewing Miring",
			category: "PROSES",
			deskripsi: "Jalur jahitan tidak sesuai pola/gambar kerja.",
		},
		{
			id_defect: "SEWING_NITIK",
			name: "Sewing Nitik",
			category: "PROSES",
			deskripsi: "Jahitan terlalu rapat/menumpuk di satu titik.",
		},
		{
			id_defect: "KUNCIAN_JEBOL",
			name: "Kuncian Jebol",
			category: "PROSES",
			deskripsi: "Kuncian benang awal/akhir jahitan tidak terbentuk sempurna.",
		},
		{
			id_defect: "LANGKAH_SEWING_TIDAK_SESUAI",
			name: "Langkah Sewing Tidak Sesuai",
			category: "PROSES",
			deskripsi:
				"Panjang stitch tidak memenuhi standar (misal: 3-4 stitch/cm).",
		},
		{
			id_defect: "ALUR_SERAT_TIDAK_SESUAI",
			name: "Alur Serat Tidak Sesuai",
			category: "PROSES",
			deskripsi:
				"Arah serat material tidak mengikuti arah yang ditentukan gambar.",
		},
		// Material Defects
		{
			id_defect: "BELANG",
			name: "Belang",
			category: "MATERIAL",
			deskripsi: "Warna material tidak merata/terdapat bercak warna berbeda.",
		},
		{
			id_defect: "BERJAMUR",
			name: "Berjamur",
			category: "MATERIAL",
			deskripsi: "Terdapat jamur pada permukaan material.",
		},
		{
			id_defect: "BERLUBANG",
			name: "Berlubang",
			category: "MATERIAL",
			deskripsi: "Terdapat lubang/bolong pada material mentah.",
		},
		{
			id_defect: "BRUDUL",
			name: "Brudul",
			category: "MATERIAL",
			deskripsi: "Permukaan material terurai/berjumbai.",
		},
		{
			id_defect: "CACAT_MATERIAL",
			name: "Cacat Material",
			category: "MATERIAL",
			deskripsi: "Cacat umum pada material yang tidak terklasifikasi.",
		},
		{
			id_defect: "DENT",
			name: "Dent (Penyok)",
			category: "PROSES",
			deskripsi: "Penyok akibat benturan selama proses atau handling.",
		},
		{
			id_defect: "DIMENSI_TIDAK_STANDAR",
			name: "Dimensi Tidak Standar",
			category: "PROSES",
			deskripsi: "Ukuran dimensi (panjang/lebar/tebal) di luar toleransi.",
		},
		{
			id_defect: "GALER",
			name: "Galer",
			category: "MATERIAL",
			deskripsi: "Permukaan material mengelupas/tergelupas.",
		},
		{
			id_defect: "HOLE_T_A",
			name: "Hole T/A (Lubang Press)",
			category: "PROSES",
			deskripsi: "Lubang akibat proses press tidak sesuai posisi atau dimensi.",
		},
		{
			id_defect: "KOTOR",
			name: "Kotor / Noda",
			category: "MATERIAL",
			deskripsi: "Terdapat noda oli, debu, atau kotoran lain.",
		},
		{
			id_defect: "LAMINATING_BOLONG",
			name: "Laminating Bolong",
			category: "MATERIAL",
			deskripsi: "Lapisan laminasi berlubang.",
		},
		{
			id_defect: "LAMINATING_TIDAK_MATANG",
			name: "Laminating Tidak Matang",
			category: "MATERIAL",
			deskripsi:
				"Laminasi tidak merekat sempurna/masih ada bagian yang mengembang.",
		},
		{
			id_defect: "MENGEMBANG",
			name: "Mengembang",
			category: "MATERIAL",
			deskripsi: "Material menggembung tidak sesuai bentuk standar.",
		},
		{
			id_defect: "OVER_CUTTING",
			name: "Over Cutting",
			category: "PROSES",
			deskripsi: "Pemotongan melebihi garis potong yang ditentukan.",
		},
		{
			id_defect: "SOBEK",
			name: "Sobek",
			category: "MATERIAL",
			deskripsi: "Material robek/sobek.",
		},
		{
			id_defect: "SPUNBOND_KOTOR",
			name: "Spunbond Kotor",
			category: "MATERIAL",
			deskripsi: "Lapisan spunbond terkontaminasi kotoran.",
		},
		{
			id_defect: "SPUNBOND_MENGERAS",
			name: "Spunbond Mengeras",
			category: "MATERIAL",
			deskripsi: "Spunbond kaku/mengeras tidak sesuai standar kelenturan.",
		},
		{
			id_defect: "SPUNBOND_TERLIPAT",
			name: "Spunbond Terlipat",
			category: "MATERIAL",
			deskripsi: "Lapisan spunbond terlipat sebelum atau saat laminasi.",
		},
		{
			id_defect: "SPUNBOND_TIDAK_MEREKAT",
			name: "Spunbond Tidak Merekat",
			category: "MATERIAL",
			deskripsi: "Spunbond tidak melekat pada base material.",
		},
		{
			id_defect: "TERBALIK",
			name: "Terbalik",
			category: "PROSES",
			deskripsi: "Part terpasang/terorientasi terbalik dari posisi standar.",
		},
		{
			id_defect: "TERLIPAT",
			name: "Terlipat",
			category: "MATERIAL",
			deskripsi: "Material terlipat sehingga menyebabkan kerutan permanen.",
		},
		{
			id_defect: "TIPIS",
			name: "Tipis",
			category: "MATERIAL",
			deskripsi: "Ketebalan material di bawah toleransi minimum.",
		},
		...
		},
		{
			...
			name: "Karat (Rust)",
			category: "MATERIAL",
			deskripsi: "Oksidasi atau karat pada material mentah.",
		},
		{
			id_defect: "D04",
	...
	// ========================================================================
	const processes: tipe_proses_inspectra[] = [
		"PRESS",
		"CUTTING",
		"SEWING",
		"QUALITY_CONTROL",
	...
	for (const proses of processes) {
		for (const def of slotDefinitions) {
			...
			const existing = await prisma.m_slot_waktu.findUnique({
	...
	const materials = [
		{
			code: "MAT-FELT-01",
			name: "FELT 600GSM BLACK",
			kategori_material: "FELT",
			satuan: "ROLL" as any,
			spec_ringkas: "600gsm x 120cm",
		},
		{
			code: "MAT-FELT-02",
			name: "FELT 400GSM GREY",
			kategori_material: "FELT",
			satuan: "ROLL" as any,
			spec_ringkas: "400gsm x 120cm",
		},
		{
			code: "MAT-SIL-01",
			name: "SILENCER PAD 2MM",
			kategori_material: "SILENCER",
			satuan: "LEMBAR" as any,
			spec_ringkas: "2mm x 100cm x 100cm",
		},
		{
			code: "MAT-SPB-01",
			name: "SPUNBOND 50GSM WHITE",
			kategori_material: "SPUNBOND",
			satuan: "ROLL" as any,
			spec_ringkas: "50gsm x 160cm",
		},
	];
	...
	const employees = [
		{
			...
			tipe_pekerja: "KARYAWAN" as any,
			line_process: "PRESS" as any,
		},
		{
			no_reg: "REG002",
			nama_lengkap: "Siti Aminah",
			tipe_pekerja: "KARYAWAN" as any,
			line_process: "SEWING" as any,
		},
		{
			no_reg: "REG003",
			nama_lengkap: "Agus Prayitno",
			tipe_pekerja: "PKL" as any,
			line_process: "CUTTING" as any,
		},
	];
	...
	for (const pc of partChildren) {
		const existing = await prisma.m_part_child.findFirst({
			where: {
				parent_uniq_no: pc.parent_uniq_no,
	...
	const existingSession = await prisma.checksheetSession.findUnique({
		where: { id: SESSION_ID },
	});
	if (!existingSession) {
		...
		await prisma.e_defect_checksheet.createMany({
			data: [
				...
				},
				{
					id_item: ITEM_ID,
					id_defect: "D02",
					nama_defect_snapshot: "Penyok (Dent)",
					kategori: "PROSES",
					jumlah: 42,
				},
				{
					id_item: ITEM_ID,
					id_defect: "D03",
					nama_defect_snapshot: "Karat (Rust)",
					kategori: "MATERIAL",
					jumlah: 8,
				},
				{
					id_item: ITEM_ID,
					id_defect: "D04",
					nama_defect_snapshot: "Noda Kotor (Stain)",
					kategori: "MATERIAL",
					jumlah: 20,
				},
				{
					id_item: ITEM_ID,
					id_defect: "D05",
					nama_defect_snapshot: "Lubang Meleset (Missing Hole)",
					kategori: "PROSES",
					jumlah: 5,
				},
			],
